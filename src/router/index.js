          ...
          children: [
            {
              name: 'loca',
              path: 'loca',
              component: () => import('../components/camera/LokasiA.vue'),
              wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Tables', // TODO Update docs
            },
            {
              name: 'locb',
              path: 'locb',
              component: () => import('../components/camera/LokasiB.vue'),
              wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Tables', // TODO Update docs
            },
          ],
        },
          ...
          children: [
            {
              name: 'collect_data',
              path: 'collect_data',
              component: () => import('../components/collect/Capture.vue'),
              wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Lists', // TODO Update docs
            },
          ],
        },
        {
          ...
          children: [
            {
              name: 'data_siswa',
              path: 'data_siswa',
              component: () => import('../components/data_siswa/DataSiswa.vue'),
              wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Cards', // TODO Update docs
            },
            {
              name: 'tambah_siswa',
              path: 'tambah_siswa',
              component: () => import('../components/data_siswa/TambahSiswa.vue'),
              wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Cards', // TODO Update docs
            },
          ],
        },
